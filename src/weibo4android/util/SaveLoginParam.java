...
public class SaveLoginParam {
    ...
    // 保存当前登录用户信息
    public static void savanowuserparam(Context context, String userID, String Secret,
            String UserName, String token) {
        SharedPreferences spuserID = context.getSharedPreferences("loginparam",
    ...
    public static boolean getauto(Context context) {
        SharedPreferences spuserisFirst = context.getSharedPreferences("isauto",
                Activity.MODE_PRIVATE);
